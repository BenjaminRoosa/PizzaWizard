...
def print_ingredients(ingredients):
    ...
    print(f"  -{ingredients["Flour"]} cups of wheat flour.")
    print(f"  -{ingredients["Water"]} cups of Water(H2o). Note: that 2/3 of the water will go into the dough the rest will go into the sauce.\n")
    ...
    print(f"  -{ingredients["Salt"]} tsp of Salt. Note: 1/2 in the dough, the other half will be needed in the sauce later.\n")
